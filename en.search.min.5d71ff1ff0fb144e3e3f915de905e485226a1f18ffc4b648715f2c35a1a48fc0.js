...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7a2cbb93fe704fdbef0a8bc0651d8506e1d88b0ed076afacdb313d1e004a711a.js',function(){input.required=false;search();});}
